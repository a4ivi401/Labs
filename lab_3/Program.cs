...
namespace OopLab1_3
{
    public class Square
    {
        ...
        // Конструктор за умовчанням та з параметрами (використання параметрів за умовчанням)
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Створення об'єктів. Для K2 використовуємо ІМЕНОВАНІ ПАРАМЕТРИ (обов'язкова вимога)
            ...
            // "збільшити" на 5 одиниць об’єкт К3
            K3 = K3 + 5.0;
            Console.WriteLine("\nK3 після збільшення на 5 одиниць:");
            K3.PrintData();

            // "поділити" об’єкт К2 на об’єкт К3 і результат "помістити" до об’єкта К1
            K1 = K2 / K3;
            Console.WriteLine("\nK1 після K1 = K2 / K3:");
            K1.PrintData();

            // Робота з кількома квадратами одночасно
